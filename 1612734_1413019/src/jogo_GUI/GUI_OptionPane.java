...
public class GUI_OptionPane {
	...
	public static int gameOver (char vencedor)
	{
		...
		switch(vencedor)
		{
			...
			default:
				JOptionPane.showMessageDialog(null, "Erro! Condicao de vitoria/empate nao estabelecida", "Erro!", 0, null);
				return JOptionPane.showConfirmDialog(null,"Deseja começar uma nova partida ou carregar uma?", "Xadrez", 0, 0, null);
