...
public abstract class Peca{
	...
	/**
	 * 
	 * 	Retorna a string do nome da peÁa + sua pociÁ„o no tabuleiro
	 * 
	 * */
	 ...
	 *
	 * 	Importante <!>
	 *  AllMoves n√£o precisa ser inicializada
	 *  na construcao do objeto Peca. AllMoves
	 *  deve ser inicializada quando o tabuleiro
	 *  estiver cheio de pecas, assim a fun√ß√£o 
	 *  poder√° lidar com o conflito de pecas.
	 *   
	 */
